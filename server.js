...
app.post('/chatroom', login_ok, function (req, res) {
   var save = {
      member: [req.body.작성자, req.user._id],
...
app.get('/message/:id', login_ok, function (req, res) {
   res.writeHead(200, {
   ...
   db.collection('message').find({ parent: req.params.id }).toArray(function (err, result) {
